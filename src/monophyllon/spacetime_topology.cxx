...
{
  int i,n,nc = 0,ulimit = int(event_fission_percentage*double(skeleton->cardinality(0)));
  double alpha;
  const int nv = (signed) skeleton->events.size();
...
template<class kind1,class kind2>
bool Spacetime<kind1,kind2>::interplication(int centre,double size,int D)
{
...
template<class kind1,class kind2>
void Spacetime<kind1,kind2>::regularization(bool minimal)
{
