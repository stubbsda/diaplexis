...
template<class kind>
void Complex<kind>::compute_entourages(int sheet)
{
  int i,j,k,ns,vx[2];
  std::set<int> s;
...
template<class kind>
bool Complex<kind>::consistent(int sheet) const
{
...
template<class kind>
int Complex<kind>::circuit_rank(int sheet) const
{
...
template<class kind>
int Complex<kind>::euler_characteristic(int sheet) const
{
  int i,pf = 1,chi = 0;
...
template<class kind>
int Complex<kind>::dimension(int sheet) const
{
  int i,j;
...
template<class kind>
int Complex<kind>::total_dimension(int sheet) const
{
  int i,d,sum = 0;
...
template<class kind>
int Complex<kind>::structural_index(int sheet) const
{
  int i,l,sum = 0;
...
template<class kind>
int Complex<kind>::component_analysis(std::vector<int>& component,int sheet) const
{
  int i,n,ct = 0;
...
template<class kind>
void Complex<kind>::write_topology(int sheet) const
{
  int i,j,n;
  std::vector<int> vx;
  SYNARMOSMA::UINT64 q;
...
template<class kind>
void Complex<kind>::write_incastrature(const std::string& filename,int sheet) const
{
...
template<class kind>
void Complex<kind>::get_energy_values(std::vector<double>& output,int sheet) const
{
  int i;
  const int nv = (signed) events.size();
...
template<class kind>
void Complex<kind>::get_deficiency_values(std::vector<double>& output,int sheet) const
{
  int i;
  const int nv = (signed) events.size();
...
template<class kind>
void Complex<kind>::write_graph(const std::string& filename,int sheet) const
{
  int i,j,vx[2],N1 = 0;
  double E;
...
template<class kind>
double Complex<kind>::total_energy(int sheet) const
{
  const int nv = (signed) events.size();
  double sum = 0.0;
...
template<class kind>
void Complex<kind>::determine_flexible_edges(std::vector<int>& flexible_edge) const
{
  int i,n,vx[2];
  bool e_neighbour;
  std::set<int>::const_iterator it;
