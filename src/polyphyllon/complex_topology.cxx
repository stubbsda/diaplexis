...
template<class kind>
void Complex<kind>::compute_degree_distribution(bool logarithmic,int sheet) const
{
...
template<class kind>
void Complex<kind>::compute_connectivity_distribution(bool direct,int sheet) const
{
...
template<class kind>
std::pair<double,double> Complex<kind>::random_walk(int sheet) const
{
...
template<class kind>
void Complex<kind>::compute_dependent_simplices(const std::set<int>& modified_vertices)
{
...
template<class kind>
double Complex<kind>::dimensional_stress(int v,int sheet) const
{
...
template<class kind>
double Complex<kind>::dimensional_stress(int d,int n,int sheet) const
{
...
template<class kind>
void Complex<kind>::compute_fvector(std::vector<int>& f,std::vector<int>& fstar,int sheet) const
{
  int i,j,s = 0;
...
template<class kind>
void Complex<kind>::compute_hvector(std::vector<int>& h,int sheet) const
{
  int i,j,sum;
...
template<class kind>
void Complex<kind>::vertex_degree_statistics(double* output,int sheet) const
{
  SYNARMOSMA::Graph G;  
  compute_graph(&G,sheet);
...
template<class kind>
int Complex<kind>::cyclicity(int sheet) const
{
...
template<class kind>
void Complex<kind>::compute_graph(SYNARMOSMA::Graph* G,int* offset,int sheet) const
{
  int i,vx[2];
  const int nv = (signed) events.size();
...
template<class kind>
void Complex<kind>::compute_graph(SYNARMOSMA::Graph* G,int base,int steps,int sheet) const
{
  int i,v,w,hop = 1;
  const int nv = (signed) events.size();
  SYNARMOSMA::hash_map::const_iterator qt;
...
template<class kind>
void Complex<kind>::compute_global_nexus(SYNARMOSMA::Nexus* NX,int sheet) const
{
  int i,j;
  std::vector<int> offset;
  std::set<int> vx;
...
template<class kind>
void Complex<kind>::compute_local_nexus(SYNARMOSMA::Nexus* NX,int base,int sheet) const
{
  int i,j;
  std::vector<int> offset;
  std::set<int>::const_iterator it;
...
template<class kind>
int Complex<kind>::chromatic_number(int sheet) const
{
...
template<class kind>
bool Complex<kind>::edge_parity_mutation(int u,int v,int sheet)
{
  int n;
  std::set<int> S;
  SYNARMOSMA::hash_map::const_iterator qt;
...
template<class kind>
bool Complex<kind>::simplex_deletion(int d,int n,int sheet)
{
  std::set<int>::const_iterator it;
  std::set<int> parents;
  int i,dp1 = d + 1;
...
template<class kind>
bool Complex<kind>::simplex_addition(int u,int v,const std::set<int>& locus,int n)
{
  bool output = false;
  std::set<int> S;
  std::set<int>::const_iterator it;
...
template<class kind>
bool Complex<kind>::simplex_addition(const std::set<int>& S,const std::set<int>& locus,int n)
{
  int i,j;
  std::set<int> fc;
  std::set<int>::const_iterator it,jt;
...
template<class kind>
void Complex<kind>::simplicial_implication(int sheet)
{
  int i,j,k,n,m,vx[2];
  Simplex S;
  std::string sx;
...
template<class kind>
void Complex<kind>::simplicial_implication(int base,int sheet) const
{
...
template<class kind>
int Complex<kind>::entourage(int base,int sheet) const
{
...
template<class kind>
double Complex<kind>::entwinement(int sheet) const
{
...
template<class kind>
double Complex<kind>::cyclic_resistance(int sheet) const
{
  SYNARMOSMA::Graph G;
  compute_graph(&G,sheet);
...
template<class kind>
int Complex<kind>::combinatorial_distance(int v1,int v2,int sheet) const
{
...
template<class kind>
int Complex<kind>::cardinality(int d,int sheet) const
{
  if (d < 0) return 0;
  unsigned int i;
  int n = 0;
...
template<class kind>
int Complex<kind>::vertex_valence(int v,int sheet) const
{
  int nd = 0;
  std::set<int>::const_iterator it;
...
template<class kind>
int Complex<kind>::vertex_dimension(int v,int sheet) const
{
  int i,j,n;
...
template<class kind>
double Complex<kind>::dimensional_frontier(int D,int sheet) const
{
...
template<class kind>
double Complex<kind>::dimensional_uniformity(int geometric_dimension,int sheet) const
{
...
template<class kind>
bool Complex<kind>::connected(int sheet) const
{
